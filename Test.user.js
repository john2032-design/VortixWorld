...
const modernCSS = `:root{--primary:#a855f7;--accent:#eab308;--glass:rgba(15,23,42,0.92);--glow:#c4b5fd}*{box-sizing:border-box}#modern-bypass-overlay{position:fixed;inset:0;background:rgba(2,6,23,0.96);backdrop-filter:blur(32px);z-index:2147483645;display:flex;align-items:center;justify-content:center;font-family:system-ui,sans-serif;padding:24px}#modern-bypass-overlay .bypass-container{background:var(--glass);border:1px solid rgba(192,181,253,0.5);border-radius:24px;padding:48px 32px;max-width:540px;width:100%;box-shadow:0 0 120px rgba(168,85,247,0.6),inset 0 0 80px rgba(234,179,8,0.15);text-align:center;position:relative;display:flex;flex-direction:column;align-items:center;gap:32px;overflow:hidden}.bypass-container::before{content:'';position:absolute;inset:0;background:radial-gradient(circle at 50% 20%,rgba(168,85,247,0.12),transparent 70%);pointer-events:none}.logo-section{display:flex;flex-direction:column;align-items:center;gap:18px}.logo-icon{width:128px;height:128px;background:radial-gradient(circle,#a855f7 20%,#eab308 80%);border-radius:50%;display:flex;align-items:center;justify-content:center;box-shadow:0 0 80px #a855f7,0 0 140px #eab308}.logo-icon img{width:66px;height:66px;filter:drop-shadow(0 0 20px #fff)}.logo-text{font-size:36px;font-weight:900;letter-spacing:-2px;background:linear-gradient(90deg,#f3e8ff,#fef3c7); -webkit-background-clip:text;-webkit-text-fill-color:transparent;text-shadow:0 0 50px #a855f7}.status-text{font-size:19px;color:#e0f2fe;font-weight:700}.task-type{background:rgba(168,85,247,0.12);border:2px solid #eab308;border-radius:9999px;padding:16px 36px;display:flex;align-items:center;gap:26px;width:100%}.task-icon{font-size:40px;width:70px;height:70px;background:#0f172a;border-radius:50%;display:flex;align-items:center;justify-content:center;border:5px solid #eab308}.task-info h4{margin:0;font-size:20px;color:#f1f5f9;font-weight:800}.task-info p{margin:6px 0 0;color:#94a3b8;font-size:14.5px}.progress-ring{position:relative;width:188px;height:188px}.progress-ring svg{width:100%;height:100%;transform:rotate(-90deg);filter:drop-shadow(0 0 50px #a855f7)}.progress-ring-circle{fill:none;stroke:#1e2937;stroke-width:20}.progress-ring-circle-progress{fill:none;stroke:#a855f7;stroke-width:20;stroke-linecap:round;transition:stroke-dashoffset .4s linear}.progress-text{position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);font-size:46px;font-weight:900;color:#fff;text-shadow:0 0 40px #eab308}.progress-label{position:absolute;bottom:-32px;left:50%;transform:translateX(-50%);font-size:13px;color:#eab308;letter-spacing:4px;font-weight:700;text-transform:uppercase}.footer-note{color:#94a3b8;font-size:14.5px}.result-container{display:none;flex-direction:column;gap:24px;width:100%;margin-top:20px}.result-time{color:#eab308;font-size:17px;font-weight:700}.url-display-box{background:#020617;border:2px solid #a855f7;border-radius:16px;padding:20px;color:#e0f2fe;font-family:monospace;font-size:15px;word-break:break-all;max-height:140px;overflow-y:auto}.action-btn{background:linear-gradient(#a855f7,#7e22ce);color:#fff;border:none;padding:18px 40px;border-radius:9999px;font-size:18px;font-weight:800;cursor:pointer;width:100%;box-shadow:0 12px 0 #eab308;transition:all .25s}.action-btn:active{transform:translateY(6px);box-shadow:0 6px 0 #eab308}.bypass-notification,.notification-container{z-index:2147483650}.debug-btn{position:fixed;bottom:32px;right:32px;background:#000;color:#fff;border:4px solid #fff;padding:14px 32px;border-radius:9999px;font-weight:900;font-size:15px;cursor:pointer;z-index:2147483660 !important;box-shadow:0 8px 30px rgba(0,0,0,.8);transition:all .2s}.debug-btn:active{transform:scale(0.92)}.debug-panel{position:fixed;top:50%;left:50%;transform:translate(-50%,-50%);width:90%;max-width:680px;height:82%;background:#000;border:6px solid #a855f7;border-radius:24px;z-index:2147483661 !important;display:none;flex-direction:column;overflow:hidden;box-shadow:0 0 120px #a855f7}.debug-panel-header{background:#111;padding:18px 26px;display:flex;justify-content:space-between;align-items:center;border-bottom:4px solid #333}.debug-panel-title{color:#fff;font-size:21px;font-weight:800}.debug-panel-close{color:#fff;font-size:34px;cursor:pointer;line-height:1}.debug-logs{flex:1;overflow-y:auto;padding:22px;font-family:monospace;font-size:14.5px;line-height:1.55;background:#020617;color:#fff}.debug-log-info{color:#60a5fa}.debug-log-warn{color:#fbbf24}.debug-log-error{color:#ef4444}.debug-panel-footer{padding:18px;background:#111;border-top:4px solid #333;display:flex;justify-content:center}.debug-copy-btn{background:#1f2937;color:#fff;border:4px solid #a855f7;padding:14px 40px;border-radius:9999px;font-weight:800;cursor:pointer;font-size:16px}@media (max-width:480px){.debug-panel{width:96%;height:88%}}`;
