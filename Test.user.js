...
Logger.info(`VortixWorld Lootlinks Bypass v7.9 initialized`, new Date().toISOString());
...
const modernCSS = `:root{--primary:#8b5cf6;--accent:#fbbf24;--darker:#0f172a;--light:#f8fafc;--gray:#94a3b8;--success:#10b981;--warning:#f59c00}*{box-sizing:border-box}#modern-bypass-overlay{position:fixed;inset:0;background:rgba(15,23,42,.98);z-index:2147483645;display:flex;align-items:center;justify-content:center;font-family:system-ui,sans-serif;padding:20px}#modern-bypass-overlay .bypass-container{background:linear-gradient(180deg,#1a2338,#0c1426);border:4px solid #4c1d95;border-radius:20px;padding:40px 28px;max-width:520px;width:100%;box-shadow:0 0 80px rgba(139,92,246,.6),inset 0 0 60px rgba(251,191,36,.2);text-align:center;position:relative;display:flex;flex-direction:column;align-items:center;gap:28px}.logo-section{display:flex;flex-direction:column;align-items:center;gap:16px}.logo-icon{width:110px;height:110px;background:radial-gradient(circle at 30% 30%,#8b5cf6,#fbbf24);border-radius:50%;display:flex;align-items:center;justify-content:center;box-shadow:0 0 60px #8b5cf6,0 0 100px #fbbf24}.logo-icon img{width:58px;height:58px;filter:drop-shadow(0 0 12px #fff)}.logo-text{font-size:32px;font-weight:900;letter-spacing:-1.5px;background:linear-gradient(90deg,#fff,#e0bbff); -webkit-background-clip:text;-webkit-text-fill-color:transparent;text-shadow:0 0 40px #8b5cf6}.status-text{font-size:18px;color:#cbd5e1;font-weight:700}.task-type{background:rgba(139,92,246,.15);border:3px solid #fbbf24;border-radius:9999px;padding:14px 32px;display:flex;align-items:center;gap:24px;width:100%}.task-icon{font-size:36px;width:64px;height:64px;background:#0f172a;border-radius:50%;display:flex;align-items:center;justify-content:center;border:4px solid #fbbf24}.task-info h4{margin:0;font-size:19px;color:#fff;font-weight:800}.task-info p{margin:4px 0 0;color:#64748b;font-size:14px}.progress-ring{position:relative;width:172px;height:172px}.progress-ring svg{width:100%;height:100%;transform:rotate(-90deg);filter:drop-shadow(0 0 35px #8b5cf6)}.progress-ring-circle{fill:none;stroke:#1e2937;stroke-width:18}.progress-ring-circle-progress{fill:none;stroke:#8b5cf6;stroke-width:18;stroke-linecap:round;transition:stroke-dashoffset .35s linear}.progress-text{position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);font-size:42px;font-weight:900;color:#fff;text-shadow:0 0 30px #fbbf24}.progress-label{position:absolute;bottom:-26px;left:50%;transform:translateX(-50%);font-size:12px;color:#fbbf24;letter-spacing:3px;font-weight:700;text-transform:uppercase}.footer-note{color:#64748b;font-size:14px}.result-container{display:none;flex-direction:column;gap:20px;width:100%;margin-top:16px}.result-time{color:#fbbf24;font-size:16px;font-weight:700}.url-display-box{background:#0a0f1c;border:3px solid #8b5cf6;border-radius:14px;padding:18px;color:#e0f2fe;font-family:monospace;font-size:14.5px;word-break:break-all;max-height:130px;overflow-y:auto}.action-btn{background:linear-gradient(#8b5cf6,#7c3aed);color:#fff;border:none;padding:18px 32px;border-radius:9999px;font-size:18px;font-weight:800;cursor:pointer;width:100%;box-shadow:0 10px 0 #fbbf24;transition:all .2s}.action-btn:active{transform:translateY(6px);box-shadow:0 4px 0 #fbbf24}.bypass-notification,.notification-container{z-index:2147483650}.debug-btn{position:fixed;bottom:28px;right:28px;background:#000;color:#fff;border:3px solid #fff;padding:12px 26px;border-radius:9999px;font-weight:800;font-size:14px;cursor:pointer;z-index:2147483655 !important;box-shadow:0 6px 20px rgba(0,0,0,.7);transition:all .2s}.debug-btn:active{transform:scale(.92)}.debug-panel{position:fixed;top:50%;left:50%;transform:translate(-50%,-50%);width:88%;max-width:660px;height:80%;background:#000;border:5px solid #8b5cf6;border-radius:20px;z-index:2147483656 !important;display:none;flex-direction:column;overflow:hidden;box-shadow:0 0 100px #8b5cf6}.debug-panel-header{background:#111;padding:16px 24px;display:flex;justify-content:space-between;align-items:center;border-bottom:3px solid #333}.debug-panel-title{color:#fff;font-size:20px;font-weight:800}.debug-panel-close{color:#fff;font-size:32px;cursor:pointer;line-height:1}.debug-logs{flex:1;overflow-y:auto;padding:20px;font-family:monospace;font-size:14px;line-height:1.5;background:#050505}.debug-log-info{color:#60a5fa}.debug-log-warn{color:#fbbf24}.debug-log-error{color:#ef4444}.debug-panel-footer{padding:16px;background:#111;border-top:3px solid #333;display:flex;justify-content:center}.debug-copy-btn{background:#1a1a1a;color:#fff;border:3px solid #8b5cf6;padding:12px 36px;border-radius:9999px;font-weight:800;cursor:pointer;font-size:15px}@media (max-width:480px){.debug-panel{width:96%;height:86%}}`;
...
function appendLogToPanel(type, msg, data) {
    ...
    entry.innerHTML = `<span style="opacity:.65">[${new Date().toLocaleTimeString()}]</span> <span class="${colorClass}">[${type.toUpperCase()}]</span> ${msg} ${data ? `<span style="opacity:.55">→ ${typeof data === 'object' ? JSON.stringify(data).slice(0,140) : data}</span>` : ''}`;
