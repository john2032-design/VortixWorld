window.VortixSettings = (function() {
    ...
    const CSS = `
        #vw-gear-btn { position: fixed; bottom: 20px; right: 20px; width: 50px; height: 50px; background: #0f172a; border: 2px solid #38bdf8; border-radius: 50%; color: #38bdf8; cursor: pointer; display: flex; align-items: center; justify-content: center; z-index: 2147483647 !important; box-shadow: 0 0 20px rgba(56, 189, 248, 0.2); transition: transform 0.3s; }
        #vw-gear-btn:hover { transform: rotate(90deg) scale(1.1); background: #1e293b; }
        #vw-gear-btn svg { width: 28px; height: 28px; }
        #vw-modal-overlay { position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.7); backdrop-filter: blur(5px); z-index: 2147483647 !important; display: none; align-items: center; justify-content: center; }
